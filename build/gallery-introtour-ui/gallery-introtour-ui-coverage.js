...
return html;
	...
	generateSlideDom = function(toppos,leftpos,ci,id,type,seqid){
		_yuitest_coverfunc("build/gallery-introtour-ui/gallery-introtour-ui.js", "generateSlideDom", 85);
...
if(!type){button = ATTRS.buttonnav;}
		else {_yuitest_coverline("build/gallery-introtour-ui/gallery-introtour-ui.js", 89);
...
Y.one('body').appendChild(node);
	...
	getCardPos = function(ci,pos){
		_yuitest_coverfunc("build/gallery-introtour-ui/gallery-introtour-ui.js", "getCardPos", 104);
...
Y.Introtour.init = function(cardinfo,cardstyle){
		_yuitest_coverfunc("build/gallery-introtour-ui/gallery-introtour-ui.js", "init", 143);
...
Y.on("click",function(){
			_yuitest_coverfunc("build/gallery-introtour-ui/gallery-introtour-ui.js", "(anonymous 3)", 163);
_yuitest_coverline("build/gallery-introtour-ui/gallery-introtour-ui.js", 164);
var seqid = this.getAttribute("data-seqid"),
			carddivid = "";
			_yuitest_coverline("build/gallery-introtour-ui/gallery-introtour-ui.js", 166);
...
carddivid = "#galleryintrotourui-card-1";
			}else {_yuitest_coverline("build/gallery-introtour-ui/gallery-introtour-ui.js", 169);
if(seqid === "end"){
